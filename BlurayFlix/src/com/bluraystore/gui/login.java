...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setBackground(new java.awt.Color(22, 52, 51));
        btnLogin.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        btnLogin.setForeground(new java.awt.Color(249, 210, 105));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try (Connection con = koneksi.getConnection()) {
            ...
            String query = "SELECT * FROM akun WHERE uname ='" + username + "' AND pwd = '" + pass + "'";
